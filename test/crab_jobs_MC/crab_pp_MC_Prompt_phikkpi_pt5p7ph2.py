...
config.General.requestName = 'Dfinder_MC_pp_Ds_Prompt_phikkpi_pt5p7ph2_0318'
...
config.Data.inputDataset = '/Ds_Prompt_phikkpi_pp/chengchi-RAWHLTReco_pp_Ds_Prompt_phikkpi_pt5p7ph2_Pythia8_180309-095f67a62c327b8ee7fbb78c897a67b5/USER' #need to be filled by hand
config.Data.inputDBS ='phys03'
config.Data.splitting = 'FileBased'
config.Data.unitsPerJob = 10
config.Data.outLFNDirBase = '/store/user/%s/Dsfinder_18227/pp_MC/' % (getUsernameFromSiteDB())
#config.Data.publication = True
config.Data.outputDatasetTag = 'Dfinder_MC_pp_Ds_Prompt_phikkpi_pt5p7ph2_0318'
