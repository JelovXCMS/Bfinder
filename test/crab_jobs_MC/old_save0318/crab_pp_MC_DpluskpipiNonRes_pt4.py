...
config.General.requestName = 'MC_pp_Dplus_kpipiNonRes_pt4'
...
config.Data.inputDataset = '/Dplus_kpipiNonRes_pp/chengchi-Ds_RAWHLTReco_Dplus_kpipiNonRes_pt4_Pythia8_180223-095f67a62c327b8ee7fbb78c897a67b5/USER'
config.Data.inputDBS ='phys03'
config.Data.splitting = 'FileBased'
config.Data.unitsPerJob = 1
config.Data.outLFNDirBase = '/store/user/%s/Dsfinder_18227/pp_MC/' % (getUsernameFromSiteDB())
#config.Data.publication = True
config.Data.outputDatasetTag = 'MC_pp_Dplus_kpipiNonRes_pt4'
