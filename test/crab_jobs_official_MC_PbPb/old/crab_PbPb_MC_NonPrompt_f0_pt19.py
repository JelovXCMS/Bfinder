...
config.General.requestName = 'Dfinder_MC_PbPb_Ds_NonPrompt_phi_pt19'
...
config.Data.inputDataset = '/NonPrDs-f0Pi_pThat-9_DsPT-19_HydjetCymbMB_5p02_Pythia8/HINPbPbWinter16DR-75X_mcRun2_HeavyIon_v14-v1/AODSIM' #need to be filled by hand
config.Data.inputDBS ='global'
config.Data.splitting = 'FileBased'
config.Data.unitsPerJob = 2
config.Data.outLFNDirBase = '/store/group/hi/%s/Dsfinder_officialMC_test/PbPb_MC/' % (getUsernameFromSiteDB())
#config.Data.publication = True
config.Data.outputDatasetTag = 'Dfinder_MC_PbPb_Ds_NonPrompt_phi_pt19'
