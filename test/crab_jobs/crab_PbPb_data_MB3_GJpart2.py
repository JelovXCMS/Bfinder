...
config.General.requestName = 'Data_PbPb_Ds_phikkpi_HiMB3_GJpart2'
...
config.Data.outputDatasetTag = 'Data_PbPb_Ds_phikkpi_HiMB3_GJpart2'

config.Data.lumiMask = 'Cert_262548-263757_PromptReco_HICollisions15_JSON_v2_part2.txt'
