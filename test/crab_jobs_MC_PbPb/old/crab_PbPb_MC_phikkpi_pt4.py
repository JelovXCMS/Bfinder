...
config.General.requestName = 'DsFinder_MC_PbPb_Ds_phikkpi_pt4'
...
config.Data.inputDataset = '/Ds_phikkpi_PbPb/chengchi-Reco_Ds_phikkpi_PbPb_pt4_Pythia8_180309-eef725472e9d7138234fbfd165e44059/USER'
config.Data.inputDBS ='phys03'
config.Data.splitting = 'FileBased'
config.Data.unitsPerJob = 2
config.Data.outLFNDirBase = '/store/user/%s/Dsfinder_18227/PbPb_MC/' % (getUsernameFromSiteDB())
#config.Data.publication = True
config.Data.outputDatasetTag = 'DsFinder_MC_PbPb_Ds_phikkpi_pt4'
