...
config.General.requestName = 'Dfinder_MC_PbPb_Ds_Prompt_phikkpi_pt1p8'
...
config.Data.inputDataset = '/Ds_Prompt_phikkpi_PbPb/chengchi-Reco_PbPb_Ds_Prompt_phikkpi_pt1p8_Pythia8_180309-eef725472e9d7138234fbfd165e44059/USER' #need to be filled by hand
config.Data.inputDBS ='phys03'
config.Data.splitting = 'FileBased'
config.Data.unitsPerJob = 2
config.Data.outLFNDirBase = '/store/user/%s/Dsfinder_18227/PbPb_MC/' % (getUsernameFromSiteDB())
#config.Data.publication = True
config.Data.outputDatasetTag = 'Dfinder_MC_PbPb_Ds_Prompt_phikkpi_pt1p8'
