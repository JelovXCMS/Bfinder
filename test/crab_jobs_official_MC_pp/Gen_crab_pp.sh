...
config.JobType.psetName = '../finder_pp_75X_mc_cfg.py'
#config.JobType.maxMemoryMB = 3500  ## some job failed in deafult 2000 (MB)


config.Data.inputDataset = '/${PNP}Ds-${Channel}_pThat-${pthat}_DsPT-${ptname}_pp_5p02_Pythia8/HINppWinter16DR-75X_mcRun2_asymptotic_ppAt5TeV_v3-v1/AODSIM' #need to be filled by hand
config.Data.inputDBS ='global'
config.Data.splitting = 'FileBased'
config.Data.unitsPerJob = 1
config.Data.outLFNDirBase = '/store/group/hi/%s/Dsfinder_officialMC/pp_MC_noCut20190409/' % (getUsernameFromSiteDB())
