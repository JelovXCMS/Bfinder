...
INFILELIST=input_list/Ds_pp_MC_NonPrompt22_phikkpi_pt5p7.lis
OUTPUTDIR=/scratch/halstead/p/peng43/Ds_phikkpi/Dntuple/pp_MC/Ds_pp_MC_NonPrompt22_phikkpi_pt5p7
